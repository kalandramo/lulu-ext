module github.com/kalandramo/lulu-ext/transport/rocketmq

go 1.26.1

require (
	github.com/kalandramo/lulu v0.0.0-20260617094710-09209c191f62
	github.com/kalandramo/lulu-ext v0.0.2
	github.com/kalandramo/lulu-ext/broker v0.0.0-20260626085812-ee3d9c7661fa
	github.com/kalandramo/lulu-ext/broker/rocketmq v0.0.0-20260626062056-d444ac1f45f2
	github.com/kalandramo/lulu-ext/metrics v0.0.0-20260626085812-ee3d9c7661fa
	github.com/kalandramo/lulu-ext/testing v0.0.0-20260626085812-ee3d9c7661fa
