...
//
//	import (
//	    grpccodec "github.com/kalandramo/lulu-ext/transport/grpc/middleware/codec"
//	    _ "github.com/kalandramo/lulu-ext/encoding/json" // side-effect: registers JSON codec
//	)
//
//	func main() {
