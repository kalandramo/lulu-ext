...
type (
	...
	retriesCountKey                  struct{}
	mechanismKey                     struct{}
	loggerKey                        struct{}
	errorLoggerKey                   struct{}
	enableLoggerKey                  struct{}
	enableErrorLoggerKey             struct{}
	enableOneTopicOneWriterKey       struct{}
	batchSizeKey                     struct{}
...
type (
	autoSubscribeCreateTopicKey   struct{}
	autoSubscribeCreateTopicValue struct {
		Topic             string
		NumPartitions     int
...
type (
	...
	partitionKey              struct{}
	readBatchTimeoutKey       struct{}
	readBackoffMin            struct{}
	readBackoffMax            struct{}
)

type subscribeRetriesCountKey struct{}

type (
	subscribeBatchSizeKey     struct{}
	subscribeBatchIntervalKey struct{}
)
