...
import (
	...
	_ "github.com/kalandramo/lulu-ext/encoding/json" // side-effect: register JSON codec
	_ "github.com/kalandramo/lulu-ext/encoding/xml"  // side-effect: register XML codec
