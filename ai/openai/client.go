...
func NewClient(cfg *Config, opts ...Option) (*openai.Client, error) {
	if cfg == nil {
...
func newCloudClient(cfg *Config, o *options) (*openai.Client, error) {
	if cfg.Cloud == nil {
...
func newLocalClient(cfg *Config, o *options) (*openai.Client, error) {
	if cfg.Local == nil {
...
func setHTTPClient(cfg *Config, o *options, c *openai.ClientConfig) {
	if o.httpClient != nil {
