...
func (mockRegistrar) Register(context.Context, *lulu.Instance) error   { return nil }
func (mockRegistrar) Deregister(context.Context, *lulu.Instance) error { return nil }

type mockDiscovery struct{}

func (mockDiscovery) GetService(context.Context, string) ([]*lulu.Instance, error) {
	return nil, nil
}
...
func (mockWatcher) Next(context.Context) ([]*lulu.Instance, error) { return nil, nil }
